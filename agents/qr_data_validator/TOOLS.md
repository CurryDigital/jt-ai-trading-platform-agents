...
- views: v_pending_events (for Hub), v_qr_data_validator_work (for Validator)

## Quick SQL patterns
- Pending events: SELECT id AS event_id, event_type, strategy_id, payload_json, created_at FROM openclaw_researcher.v_qr_data_validator_work LIMIT 5;
